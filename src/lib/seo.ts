...
const seoConfig: Record<PageKey, Record<Locale, SeoEntry>> = {
  ...
  services: {
    zh: {
      title: "服務項目",
      description:
        "完整鞋包護理服務：專業洗鞋、精品洗包、鞋類修復、包類修復、改色翻新與五金保養，依物件材質量身規劃方案。",
      keywords: ["洗鞋服務", "洗包服務", "皮件保養", "改色翻新", "五金除氧化"],
    },
    en: {
      title: "Services",
      description:
        "Complete shoe & bag care: shoe cleaning, bag cleaning, shoe repair, bag repair, recolouring and hardware care — tailored to each material.",
      keywords: [
        "shoe cleaning service",
        "bag cleaning service",
        "leather care",
        "recolour",
        "hardware de-oxidation",
      ],
    },
  },
  cases: {
    zh: {
      title: "案例分享",
      description:
        "真實處理前後對比案例，涵蓋球鞋清潔、精品包保養、改色翻新與修復，見證職人工法的煥新成果。",
      keywords: ["洗鞋案例", "洗包案例", "改色案例", "鞋包修復前後對比"],
    },
    en: {
      title: "Case Studies",
      description:
        "Real before-and-after results across sneaker cleaning, luxury bag care, recolouring and repair — proof of our artisan craft.",
  ...
  about: {
    zh: {
      title: "關於我們",
      description:
        "RENU 源自 Renew，師承傳統皮件職人，以實驗室般嚴謹的工法對待每一件珍藏。認識我們的故事、堅持與專業團隊。",
      keywords: ["RENU 關於我們", "鞋包護理職人", "皮件保養專家"],
    },
    en: {
      title: "About",
      description:
        "RENU stands for Renew. Trained under traditional leather artisans, we treat every treasure with laboratory rigour. Meet our story, values and team.",
  ...
  faq: {
    zh: {
      title: "常見問題",
      description:
        "服務工期、收送件方式、報價、保固與改色處理等常見問題解答，託付前先了解 RENU 的服務細節。",
      keywords: ["洗鞋常見問題", "洗包報價", "鞋包護理保固"],
    },
    en: {
      title: "FAQ",
      description:
        "Answers on turnaround, drop-off and delivery, pricing, guarantees and recolouring — everything to know before entrusting your piece to RENU.",
  ...
  contact: {
    zh: {
      title: "聯絡我們",
      description:
        "歡迎透過 LINE、電話或預約表單聯繫 RENU。桃園市八德區義勇街 48 號，每日 11:30–20:30 為你服務。",
      keywords: ["RENU 聯絡", "桃園洗鞋預約", "洗包諮詢"],
    },
    en: {
      title: "Contact",
      description:
        "Reach RENU via LINE, phone or our booking form. No. 48, Yiyong St., Bade Dist., Taoyuan City — open daily 11:30–20:30.",
